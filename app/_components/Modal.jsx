...
const Modal = () => {
  ...
  const {state:animState,playIndivAnim,playIndivAnimFin,fadeAnim,setCurrAnim}=useAnimManagerContext()
  ...
  const handleAnswerCheck = (MyAns) => {
    ...
    if (answer === MyAns) {
      ...
      playIndivAnim([
        {
          animation: "bye_Retarget",
          facialExpression: "smile",
          audio: "C-C.mp3",
        },
      ]);
      // setCurrAnim("bye_Retarget")
    } else {
      ...
      // playIndivAnimFin();
       // Re-enable button after feedback
        ...
        answerStatus==="wrong"?setCurrAnim("bye_Retarget"):setCurrAnim("bye_Retarget")
